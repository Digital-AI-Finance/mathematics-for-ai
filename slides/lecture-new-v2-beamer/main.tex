...
\begin{frame}{\pillartag{PillarBlue}{P1}Words as Vectors \badge{PillarBlue}{AI Connection}}
  ...
  \onslide<2->{
    \includegraphics[height=0.14\textheight, keepaspectratio]{12-embedding-space.png}\par
  }
...
\begin{frame}{\pillartag{PillarGreen}{P2}Turning Scores into Probabilities}
  \centering
  \includegraphics[height=0.16\textheight, keepaspectratio]{03-softmax.png}\par\smallskip
  ...
  \onslide<3->{
    \includegraphics[height=0.14\textheight, keepaspectratio]{xkcd-frequentists-bayesians.png}\par
...
\begin{frame}{\pillartag{PillarOrange}{P3}Backpropagation = The Chain Rule \badge{AccentYellow}{Breakthrough}}
  ...
  \begin{columns}[T]
    \begin{column}{0.57\textwidth}
      \centering
      \includegraphics[height=0.14\textheight, keepaspectratio]{18-backprop-flow.png}
    \end{column}
    \begin{column}{0.38\textwidth}
      \centering
...
\begin{frame}{\pillartag{PillarTeal}{P4}Shannon's Model $\to$ The LLM Pipeline}
  \centering
  \includegraphics[height=0.35\textheight, keepaspectratio]{07-shannon-diagram.png}\par\medskip
...
\begin{frame}{\pillartag{PillarYellow}{P5}The Evolution of Optimizers \badge{PillarTeal}{Discovery}}
  \centering
  \includegraphics[height=0.16\textheight, keepaspectratio]{08-optimizers.png}\par\smallskip
  ...
  \onslide<5->{
    ...
    {\scriptsize\color{TextSecondary} xkcd.com/1838 (CC BY-NC 2.5)}
  }
...
\begin{frame}{\pillartag{PillarYellow}{P5}More Math, Better AI \badge{PillarBlue}{AI Connection}}
  \centering
  \includegraphics[height=0.16\textheight, keepaspectratio]{09-scaling-laws.png}\par\smallskip
  ...
  \onslide<3->{
    ...
    {\scriptsize\color{TextSecondary} xkcd.com/2048 (CC BY-NC 2.5)}
  }
...
\begin{frame}{Where All Five Pillars Meet}
  \centering
  \includegraphics[height=0.16\textheight, keepaspectratio]{10-convergence.png}\par\medskip
  ...
  \onslide<2->{
    ...
    \pillaritem{PillarYellow}{Optimization}{Scale}\par\smallskip
  }
...
\begin{frame}{The Code Is Still Being Written}
  \centering
  \includegraphics[height=0.12\textheight, keepaspectratio]{19-radar-pillars.png}\par\medskip
