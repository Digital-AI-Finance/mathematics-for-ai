...
\begin{frame}{\pillartag{PillarGreen}{P2}Turning Scores into Probabilities}
  ...
  \onslide<3->{
    \includegraphics[height=0.16\textheight, keepaspectratio]{xkcd-frequentists-bayesians.png}\par
...
\begin{frame}{\pillartag{PillarTeal}{P4}Shannon's Model $\to$ The LLM Pipeline}
  \centering
  \includegraphics[height=0.25\textheight, keepaspectratio]{07-shannon-diagram.png}\par\medskip
...
\begin{frame}{\pillartag{PillarYellow}{P5}The Evolution of Optimizers \badge{PillarTeal}{Discovery}}
  ...
  \onslide<5->{
    \includegraphics[height=0.16\textheight, keepaspectratio]{xkcd-machine-learning.png}\par
...
\begin{frame}{\pillartag{PillarYellow}{P5}More Math, Better AI \badge{PillarBlue}{AI Connection}}
  ...
  \onslide<3->{
    \includegraphics[height=0.16\textheight, keepaspectratio]{xkcd-curve-fitting.png}\par
